...
#endif
// {AC_TASK_AIRCOND_SCENE_ID, TASK_PRI_LEVEL_4, task_aircond_scene},
...
/*************************************************************************/
    ...
    /* END OF TABLE */
    /*************************************************************************/
    // {CORE_TASK_EOT_ID, TASK_PRI_LEVEL_0, (pf_task)0}
};
const task_polling_t app_task_polling_table[] = {
    {AC_TASK_POLLING_ZIGBEE_ID, CORE_ENABLE, task_polling_zigbee},
    {AC_TASK_POLLING_CONSOLE_ID, CORE_ENABLE, task_polling_console},
    // {CORE_TASK_POLLING_EOT_ID, CORE_DISABLE, (pf_task_polling)0},
};
