...
void ring_buffer_init(ring_buffer_t* ring_buffer, void* buffer,
...
uint8_t ring_buffer_put(ring_buffer_t* ring_buffer, void* data) {
    ...
    if (data != NULL) {
        memcpy((uint8_t*)(ring_buffer->buffer +
                          ring_buffer->tail_index * ring_buffer->element_size),
               (uint8_t*)data, ring_buffer->element_size);

        next_tail_index =
            (++ring_buffer->tail_index) % ring_buffer->buffer_size;
    ...
    if (data != NULL) {
        memcpy((uint8_t*)data,
               (uint8_t*)(ring_buffer->buffer +
                          ring_buffer->head_index * ring_buffer->element_size),
...
void ring_buffer_char_init(ring_buffer_char_t* ring_buffer, void* buffer,
